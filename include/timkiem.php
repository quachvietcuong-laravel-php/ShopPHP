<?php 
	if (isset($_POST['search_button'])) {
		$tukhoa      = addslashes($_POST['search_product']);
		$sql_product = mysqli_query($con , "SELECT * FROM tbl_product WHERE product_name LIKE '%$tukhoa%' ORDER BY product_id DESC");
...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Từ khóa tìm kiếm: <?php echo $tukhoa; ?>	
			</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<?php 
								...
								echo '<div class="alert alert-danger" role="alert">Không tìm thấy sản phẩm</div>';
							}
						?>
						<!-- //first section -->
					</div>
