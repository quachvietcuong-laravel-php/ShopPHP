<?php 
	...
	$sql_cate  = mysqli_query($con , "SELECT * FROM tbl_category,tbl_product WHERE tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id='$id' ORDER BY tbl_product.product_id DESC");

	$sql_title = mysqli_query($con , "SELECT * FROM tbl_category,tbl_product WHERE tbl_category.category_id = tbl_product.category_id AND tbl_product.category_id='$id' ORDER BY tbl_product.product_id DESC");
